...
public class DoneCancelView extends LinearLayout {
    ...
    public void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.riv_done_cancel_view, this);
        doneButton = findViewById(R.id.riv_ok_button);
        cancelButton = findViewById(R.id.riv_cancel_button);
